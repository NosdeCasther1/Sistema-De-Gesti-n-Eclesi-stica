...
<head>
    ...
    <style>
        ...
        .stats { margin-bottom: 20px; font-size: 12px; font-weight: bold; color: #0f172a; }
    </style>
</head>
<body>
    <div class="header">
        ...
        <div style="font-size: 11px; color: #888;">Generado el {{ now()->format('d/m/Y') }}</div>
    </div>

    <div class="stats">
        Total de Bautizados Activos: {{ count($miembros) }}
    </div>
