...
@section('header_subtitle', 'Multiplicación, pastoreo y censo sectorizado')
@section('header_icon')
...
<div class="bento-container">
    ...
    <div class="card-module p-4 mb-4 shadow-sm flex-shrink-0">
        <form action="{{ route('celulas.index') }}" method="GET" id="searchForm" class="max-w-xl m-0">
    ...
    {{-- ===== GRID RESULTADOS ===== --}}
    <div class="overflow-y-auto flex-grow pb-4" style="min-height: 0;" id="grid-results">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(e) {
            let pagLink = e.target.closest('.tailwind-pagination a') || e.target.closest('.pagination a') || e.target.closest('#grid-results nav a');
            if(pagLink) {
                e.preventDefault();
