...
<div class="min-h-screen bg-slate-50 dark:bg-[#0B1121] p-4 lg:p-8 font-sans antialiased -m-4">
    ...
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-black text-slate-900 dark:text-white tracking-tight">Editar Célula: {{ $celula->nombre }}</h2>
                <p class="text-xs text-slate-500 dark:text-slate-400 mt-1 font-medium">Actualice la información de liderazgo, horarios y dirección de la célula.</p>
            </div>
