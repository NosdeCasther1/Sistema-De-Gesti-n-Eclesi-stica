            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="direccion" value="{{ old('direccion', $familia->direccion) }}" placeholder="Ej: 4ta Calle 5-20"
                               class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-white text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm">
                    </div>
                    <div>
                        <label class="block text-[11px] font-extrabold uppercase tracking-wider text-slate-500 dark:text-slate-400 mb-1.5">Zona</label>
                        <input type="text" name="zona" value="{{ old('zona', $familia->zona) }}" placeholder="Ej: Zona 1"
                               class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-white text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm">
                    </div>
                    <div>
                        ...
                        <input type="text" name="municipio" value="{{ old('municipio', $familia->municipio) }}" placeholder="Ej: Mixco"
                               class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-white text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm">
                    </div>
                    <div>
                        ...
                        <input type="text" name="departamento" value="{{ old('departamento', $familia->departamento) }}" placeholder="Ej: Guatemala"
                               class="w-full rounded-xl border border-slate-300 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800 px-4 py-3.5 text-slate-900 dark:text-white text-xs font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm">
                    </div>
                    <div class="md:col-span-2">
