...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="fw-bold mb-1">Editar Familia: {{ $familia->nombre }}</h2>
        <p class="text-muted small mb-0">Modifique los datos generales del núcleo familiar.</p>
    </div>
    ...
    <form action="{{ route('familias.update', $familia->id) }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12">
                ...
                <input type="text" name="nombre" class="form-control form-control-lg" value="{{ old('nombre', $familia->nombre) }}" placeholder="Ej: Familia Pérez García" required>
            </div>
            <div class="col-md-6">
                <label class="form-label">Teléfono Principal</label>
                <input type="text" name="telefono_principal" class="form-control" value="{{ old('telefono_principal', $familia->telefono_principal) }}" placeholder="Ej: 5555-1234">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-12">
                ...
                <textarea name="direccion" class="form-control" rows="2" placeholder="Calle, Avenida, Zona, Municipio...">{{ old('direccion', $familia->direccion) }}</textarea>
            </div>
            <div class="col-12">
                <label class="form-label">Notas / Observaciones</label>
                <textarea name="notas" class="form-control" rows="2" placeholder="Información adicional relevante sobre la familia...">{{ old('notas', $familia->notas) }}</textarea>
            </div>
        </div>
