        ...
        <form action="{{ route('inventario.store') }}" method="POST" class="p-6 md:p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="nombre" value="{{ old('nombre') }}" class="w-full bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all shadow-sm @error('nombre') border-red-500 @enderror" required placeholder="Ej. Silla plástica blanca, Micrófono Shure...">
                ...
                <div>
                    ...
                    <input type="number" name="cantidad" value="{{ old('cantidad', 1) }}" min="1" class="w-full bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all shadow-sm @error('cantidad') border-red-500 @enderror" required>
                ...
                <div>
                    ...
                    <input type="text" name="ubicacion" value="{{ old('ubicacion') }}" class="w-full bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all shadow-sm @error('ubicacion') border-red-500 @enderror" placeholder="Ej. Almacén principal, Templo...">
                ...
                <div>
                    ...
                    <input type="date" name="fecha_adquisicion" value="{{ old('fecha_adquisicion') }}" class="w-full bg-gray-50 dark:bg-slate-800 border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all shadow-sm @error('fecha_adquisicion') border-red-500 @enderror">
