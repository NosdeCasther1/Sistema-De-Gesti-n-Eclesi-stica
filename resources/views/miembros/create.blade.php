                    ...
                    <div class="md:col-span-2 mb-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="flex items-center p-3 border rounded-xl hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800 transition-colors">
                                <input id="bautizado_agua" name="bautizado_agua" type="checkbox" value="1" {{ old('bautizado_agua') ? 'checked' : '' }} class="h-5 w-5 rounded border-slate-300 text-blue-600 focus:ring-blue-500">
                            ...
                            <div class="flex items-center p-3 border rounded-xl hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800 transition-colors">
                                <input id="bautismo_espiritu_santo" name="bautismo_espiritu_santo" type="checkbox" value="1" {{ old('bautismo_espiritu_santo') ? 'checked' : '' }} class="h-5 w-5 rounded border-slate-300 text-amber-500 focus:ring-amber-500">
