...
<body>
    ...
    <div class="body-text">
        ...
        identificado(a) con DPI <strong>{{ $miembro->dpi }}</strong>, ha sido miembro activo y en plena comunión de nuestra congregación.
        <br><br>
        Extendemos la presente carta de traslado, recomendando al hermano(a) para que pueda integrarse activamente a una nueva congregación local donde el Señor le dirija, deseando que siga siendo de bendición.
    </div>
