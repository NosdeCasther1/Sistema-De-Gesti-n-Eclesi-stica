                    ...
                    <div class="row mb-4 bg-light p-3 rounded" style="border: 1px solid #f0f0f0;">
                        <div class="col-md-5 mb-2 mb-md-0">
                            ...
                            <div class="input-group search-group"
                                ...
                                <button class="btn bg-white border-start-0 border text-muted clear-search" type="button" id="clearSearch" style="display: none;">
...
<script>
    document.getElementById('searchInput').addEventListener('input', function () {
        ...
        rows.forEach(row => {
            ...
            const referencia = cells[0].textContent.toLowerCase();
            const tipoGasto = cells[3].textContent.toLowerCase();
