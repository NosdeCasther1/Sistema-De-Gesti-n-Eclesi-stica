        ...
        <div class="container-fluid py-4 px-4 mb-5">
            <div class="page-header mb-4 d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted">Consulta y exporta el historial y la planificación de las actividades de la iglesia.</p>
                </div>
                <div>
...
<!-- Scripts (Daterangepicker dependencies are already in footer or here) -->
...
<script>
    ...
    function exportarPDF() {
        ...
        window.location.href = `<?php echo BASE_URL; ?>/exportar_pdf_eventos.php?${params.toString()}`;
    }
</script>