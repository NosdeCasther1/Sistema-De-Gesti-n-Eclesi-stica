...
if (isset($_SESSION['usuario_id'])) {
    header("Location: /ProyectoIglesia/inicio");
    exit();
}
...
<head>
    ...
    <link rel="stylesheet" href="/ProyectoIglesia/assets/css/theme.css">
    <style>
        body {
        ...
        .alert-error {
            ...
            max-width: 320px;
            font-size: 0.95rem;
            border-left: 4px solid #9F191E;
        }

        [data-theme='dark'] .container { background-color: #1e293b; }
        [data-theme='dark'] .welcome-section { background: linear-gradient(135deg, #0f172a, #1e293b); color: #f8f9fa; border-right-color: rgba(255,255,255,0.05); }
        [data-theme='dark'] .welcome-section h1 { color: #f87171; }
        [data-theme='dark'] .welcome-section p { color: #94a3b8; }
        [data-theme='dark'] .login-section { background: #1e293b; }
        [data-theme='dark'] label { color: #94a3b8; }
        [data-theme='dark'] input { background-color: #0f172a !important; color: #f8f9fa !important; border-color: rgba(255,255,255,0.1) !important; }
        [data-theme='dark'] .alert-error { background-color: rgba(159, 25, 30, 0.15); color: #f87171; border-left-color: #f87171; }
        ...
        <div class="login-section">
            ...
            <form method="POST" action="">
                ...
                <div class="actions">
                    ...
                    <a href="/ProyectoIglesia/usuarios">Registrarse</a>
                </div>
            </form>
        </div>
    </div>
    <script src="/ProyectoIglesia/assets/js/theme-controller.js"></script>
</body>
