...
class GruposUsuariosModel
{
    ...
    public function crearGrupo(string $nombre, string $descripcion): int|bool
    {
    ...
    public function actualizarGrupo(int $id, string $nombre, string $descripcion): bool
    {
    ...
    public function obtenerPermisosPorGrupo(int $grupo_id): array
    {
    ...
    public function guardarPermisos(int $grupo_id, array $permisos): bool
    {
