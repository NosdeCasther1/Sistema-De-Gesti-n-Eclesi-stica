...
<head>
    ...
    <title>Grupos de Usuarios - AD Rey de Reyes</title>
...
<body>
    ...
    <script>
        const urlController = '/ProyectoIglesia/Controladores/GruposUsuariosController.php';
        let tablaGrupos;
        ...
        function initTable() {
            tablaGrupos = $('#tablaGrupos').DataTable({
                "ajax": {
                    "url": urlController + '?action=get_grupos',
                    "type": "GET",
                    "dataSrc": "data"
                },
                "columns": [
        ...
        function editarGrupo(id, nombre, descripcion) {
            ...
            $.ajax({
                url: urlController,
                type: 'GET',
                data: { action: 'get_permisos', grupo_id: id },
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: urlController,
                        type: 'POST',
                        data: { action: 'delete_grupo', id: id },
                        success: function (response) {
